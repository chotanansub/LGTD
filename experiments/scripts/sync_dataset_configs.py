...
class DatasetConfigSynchronizer:
    ...
    def create_param_json(
        ...
        param_json = {
            ...
            "evaluation": {
                ...
                "save_plots": True,
                "plot_dir": f"results/synthetic/plots/{dataset_name}"
            }
        }
    ...
    def sync_datasets(
        ...
        if self.yaml_config_path.exists():
            ...
            experiment = {'name': 'lgtd_synthetic_evaluation', 'description': 'Synthetic data experiments for LGTD method validation', 'output_dir': 'results/synthetic'}
