...
def main():
    ...
    parser.add_argument(
        '--output-dir',
        default='results/synthetic/comparison_plots',
        help='Output directory for plots (default: results/synthetic/comparison_plots)'
    )
    parser.add_argument(
        '--init-ratio',
        type=float,
    ...
    parser.add_argument(
        '--cache-dir',
        default='results/synthetic/decompositions',
        help='Directory for cached decomposition files (default: results/synthetic/decompositions)'
    )
